...
namespace GenAiPoc.Api.Migrations
{
    ...
    [Migration("20250127085155_new_table_created_customizationTimeSaved")]
    partial class new_table_created_customizationTimeSaved
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GenAiPoc.Core.Entities.CustomizationTimeSaved", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2025, 1, 27, 8, 51, 54, 553, DateTimeKind.Utc).AddTicks(6428),
                            EstimatedTimeSavedDashboardFormat = "{d} days, {h} hours and {m} minutes",
                            ...
                            IsActive = true,
                            ModifiedDate = new DateTime(2025, 1, 27, 8, 51, 54, 553, DateTimeKind.Utc).AddTicks(6432)
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2025, 1, 27, 8, 51, 54, 553, DateTimeKind.Utc).AddTicks(6434),
                            EstimatedTimeSavedDashboardFormat = "{d} days, {h} hours and {m} minutes",
                            EstimatedTimeSavedFormula = "(Total Characters Copied/ Typing Speed) + (Total Characters Copied * Logic Time) + (Total Characters Copied * Testing Time)",
                            EstimatedTimeSavedFormulaValue = "({0}/240) + ({0} * 0.05) + ({0} * 0.04) \r\n",
                            EstimatedTimeSavedLabel = "(Total Characters Copied/240) + (Total Characters Copied * 0.05) + (Total Characters Copied * 0.04)",
                            EstimatedTimeSavedVisibotFormat = "{hh.mm} Hrs",
                            IsActive = true,
                            ModifiedDate = new DateTime(2025, 1, 27, 8, 51, 54, 553, DateTimeKind.Utc).AddTicks(6435)
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2025, 1, 27, 8, 51, 54, 553, DateTimeKind.Utc).AddTicks(6436),
                            EstimatedTimeSavedDashboardFormat = "{d} days, {h} hours and {m} minutes",
                            EstimatedTimeSavedFormula = "(Total Characters Copied * Logic Time) + (Total Characters Copied * Testing Time)",
                            EstimatedTimeSavedFormulaValue = "({0}/40) + ({0} * 0.05)",
                            EstimatedTimeSavedLabel = "(Total Characters Copied/40) + (Total Characters Copied * 0.05)",
                            EstimatedTimeSavedVisibotFormat = "{hh.mm} Hrs",
                            IsActive = true,
                            ModifiedDate = new DateTime(2025, 1, 27, 8, 51, 54, 553, DateTimeKind.Utc).AddTicks(6437)
                        });
                });
