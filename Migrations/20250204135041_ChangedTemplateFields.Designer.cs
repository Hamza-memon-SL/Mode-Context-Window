...
namespace GenAiPoc.Api.Migrations
{
    ...
    [Migration("20250204135041_ChangedTemplateFields")]
    partial class ChangedTemplateFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GenAiPoc.Core.Entities.CustomizationTimeSaved", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2025, 2, 4, 13, 50, 40, 404, DateTimeKind.Utc).AddTicks(3546),
                            ...
                            IsActive = true,
                            ModifiedDate = new DateTime(2025, 2, 4, 13, 50, 40, 404, DateTimeKind.Utc).AddTicks(3551)
                        });
                });
