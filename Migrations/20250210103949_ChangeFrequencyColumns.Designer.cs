...
namespace GenAiPoc.Api.Migrations
{
    ...
    [Migration("20250210103949_ChangeFrequencyColumns")]
    partial class ChangeFrequencyColumns
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GenAiPoc.Core.Entities.CustomizationTimeSaved", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2025, 2, 10, 10, 39, 48, 483, DateTimeKind.Utc).AddTicks(8256),
                            ...
                            IsActive = true,
                            ModifiedDate = new DateTime(2025, 2, 10, 10, 39, 48, 483, DateTimeKind.Utc).AddTicks(8261)
                        });
                });
