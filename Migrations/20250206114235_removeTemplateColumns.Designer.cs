...
namespace GenAiPoc.Api.Migrations
{
    ...
    [Migration("20250206114235_removeTemplateColumns")]
    partial class removeTemplateColumns
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GenAiPoc.Core.Entities.CustomizationTimeSaved", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2025, 2, 6, 11, 42, 34, 683, DateTimeKind.Utc).AddTicks(8047),
                            ...
                            IsActive = true,
                            ModifiedDate = new DateTime(2025, 2, 6, 11, 42, 34, 683, DateTimeKind.Utc).AddTicks(8051)
                        });
                });
