...
namespace GenAiPoc.Api.Migrations
{
    ...
    [Migration("20250224120635_new_table_created_for_main_frame_module")]
    partial class new_table_created_for_main_frame_module
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GenAiPoc.Core.Entities.CustomizationTimeSaved", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2025, 2, 24, 12, 6, 35, 199, DateTimeKind.Utc).AddTicks(3078),
                            ...
                            IsActive = true,
                            ModifiedDate = new DateTime(2025, 2, 24, 12, 6, 35, 199, DateTimeKind.Utc).AddTicks(3080)
                        });
                });
            ...
            modelBuilder.Entity("GenAiPoc.Core.Entities.MainFrameDestinationFiles", b =>
                {
                    ...
                    b.Property<int>("MainFrameSourceFileId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GenAiPoc.Core.Entities.Templates.UserTemplateFrequency", b =>
                {
                    ...
                    b.HasOne("GenAiPoc.Core.Entities.Templates.UserTemplate", null)
